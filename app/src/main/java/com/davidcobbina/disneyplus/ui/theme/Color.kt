...
val black50 = Color(0xFF151517) // For Surfaces of components, such as cards, sheets, and menus
// OnSurface Colors
// Color used for text and icons displayed on top of the surface colors
val grey150 = Color(0xFF636366) // for Text and Icons on Surfaces


// for Regular Text
val grey200 = Color(0xFF8D8D93)
